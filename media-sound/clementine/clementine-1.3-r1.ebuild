...
[[ ${PV} == *9999* ]] || \
KEYWORDS="~amd64 ~x86"
IUSE="box cdda +dbus debug dropbox gio googledrive ipod lastfm mms moodbar mtp projectm skydrive spotify spotify-blob spotify-downloader test ubuntu-one +udisks wiimote"
IUSE+="${LANGS// / linguas_}"
