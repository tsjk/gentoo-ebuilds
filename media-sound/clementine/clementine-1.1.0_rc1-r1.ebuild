...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="ayatana cdda +dbus debug gio googledrive ios ipod lastfm mms moodbar mtp projectm spotify spotify-blob spotify-downloader test +udev wiimote"
IUSE+="${LANGS// / linguas_}"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		$(cmake-utils_use spotify-downloader ENABLE_SPOTIFY_DOWNLOADER)
