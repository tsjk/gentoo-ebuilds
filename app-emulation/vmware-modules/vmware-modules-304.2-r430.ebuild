...
src_prepare() {
	...
	epatch "${FILESDIR}/vmblock-11.1.2-4.2.patch"
	epatch "${FILESDIR}/vmmon-11.1.2-4.2.patch"
	epatch "${FILESDIR}/vmnet-11.1.2-4.2.patch"
	epatch "${FILESDIR}/vsock-11.1.2-4.2.patch"
	epatch "${FILESDIR}/v4.3.patch"
