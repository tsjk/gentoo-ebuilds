...
SRC_URI="${SRC_URI}
	...
	https://github.com/compholio/wine-compholio-daily/archive/v${PV}-1.tar.gz -> wine-compholio-daily-${PV}.tar.gz"
...
src_unpack() {
	...
	unpack "wine-compholio-daily-${PV}.tar.gz"
...
src_prepare() {
	...
	make -C "../wine-compholio-daily-${PV}/patches" DESTDIR="$(pwd)" install
