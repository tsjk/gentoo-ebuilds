...
IUSE="3dnow avx avx512 busmouse debugger doc gdb ncurses readline svga sdl sdl2 rfb +smp wxwidgets vmx vnc voodoo X +x86-64"
...
src_prepare() {
	epatch "${FILESDIR}/wxGridSizer.patch"
