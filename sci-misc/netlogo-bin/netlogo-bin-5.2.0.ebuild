...
# $Header: /var/cvsroot/gentoo-x86/sci-misc/netlogo-bin/netlogo-bin-5.0.3-r1.ebuild,v 1.3 2013/07/04 12:24:01 ago Exp $
...
src_install() {
	...
	exeinto /opt/bin
	newexe "${FILESDIR}"/netlogo-5.2.0.sh netlogo
