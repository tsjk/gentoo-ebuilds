...
SRC_URI="https://ipfs.io/ipfs/QmYkdYduHWBW4VxqQs2KsBT4ABuDv8MEHAw3t9DxQKs9bm -> ${P}.zip"
#	 http://127.0.0.1:8888/CHK@ZndjoXMPzYxVTxhfpAzBMKlLYfQ~LjlDz-~N9xGB-JE,HhAoviqsLgsasYAEGPdDY3ZeeMfJa0QbIfLby8YjxEI,AAMC--8/fms-src-0.3.86.zip
RESTRICT="mirror"
S="${WORKDIR}"
...
src_configure() {
	...
	append-cxxflags -Wno-deprecated-declarations -Wno-endif-labels -Wno-unused-result
