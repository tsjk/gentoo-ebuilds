...
src_prepare() {
	local _EXPECTED_REJECTS=( 	'Makefile.rej' \
					...
					'drivers/gpu/drm/qxl/qxl_drv.c.rej' \
					'block/bfq-iosched.c.rej' \
					'block/bfq-iosched.h.rej' )
